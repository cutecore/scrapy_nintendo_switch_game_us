...
def get_america_games_web(game):
    if len(game.url) == 0:
        return -1
...
def fetchFromUrl(url, data, page):
...
def fetchFromUrlWithFilter(url, data):
...
if __name__ == "__main__":
    ...
    fetchFromUrlWithFilter(url, data)
